...
const vcjson = require('../data-store/vc.json');
/////////////////// End /////////////////////////
...
export class ViewerComponent implements OnInit {
  ...
  downloadSvgLink = jQuery('#js-download-svg');
  ...
  downloadsvg(){
    ...
    var that = this;
     this.viewer.saveXML(function (none,xml) {
       
       that.setEncoded('diagram.xml', xml);
     });
  }
      ...
      if (workItem) {
            ...
            overlayHtml
                ...
                .click((e: any) => {
                      ...
                      workItem.input.forEach((input: any) => {
                        children.forEach((child: any) => {
                          ...
                          if (child.id === input.name) {
                            ...
                            values.push(typedData.message_with_sig[input.name])
                          }
                        });
                      });
                    }
                  ...
                  let user_address = '0xE168E6B02409FeE106c13e410730E8b5461a8967'; // 로그인 연동 필요
                  let caseAddress = 0;
                  ...
                  this.http.post('http://localhost:3000' + workItem.hrefs[workItemIndex], { elementId: workItem.elementId, inputParameters: values, user: user_address})
                    .subscribe(resp => this.http.get(this.url).subscribe(resp1 => {
                      this.renderState(resp1.json())
